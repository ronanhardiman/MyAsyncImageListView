 ...
 */
package com.lq.myasyncimagelistview.image;
    ...
    private class ImageFetcher implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                //liq and 加载assets 目录下面的图片
                if(mUrl.startsWith("file:///android_asset/")){
                	bitmap = BitmapFactory.decodeStream(mContext.getAssets().open(mUrl.replaceFirst("file:///android_asset/", "")), null, (mOptions == null) ? sDefaultOptions : mOptions);
                }
                //end
